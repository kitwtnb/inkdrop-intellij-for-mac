class CodeMirrorClient {
  ...
  setSelection(line1, ch1, line2, ch2) {
    this.cm.setSelection({ line: line1, ch: ch1 }, { line: line2, ch: ch2 });
  }
  ...
  getSelectedLines() {
    ...
    return this._getValues().slice(
      selectedLineNumber.begin,
      selectedLineNumber.end + 1
    );
  }
  ...
  replaceLines(begin, lines) {
    ...
    this.cm.replaceRange(
      lines.join("\n"),
      { line: begin, ch: 0 },
      { line: lastLineNo, ch: lastLine.length }
    );
  }
