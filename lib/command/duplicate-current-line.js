function duplicateCurrentLine(cmc) {
  ...
  const lineOffset =
    isSelected && selectedArea.from.line === selectedArea.to.line ? 0 : 1;
  const toChOffset =
    selectedArea.to.ch === 0 || selectedArea.from.line !== selectedArea.to.line
      ? 0
